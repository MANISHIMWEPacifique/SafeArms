...
DO $$
DECLARE
  retained_state_count INTEGER;
BEGIN
  SELECT
    (SELECT COUNT(*) FROM anomalies) +
    (SELECT COUNT(*) FROM ml_training_features) +
    (SELECT COUNT(*) FROM ml_model_metadata)
  INTO retained_state_count;

  IF retained_state_count > 0
     AND COALESCE(current_setting('safearms.allow_destructive_seed_reset', true), 'false') <> 'true' THEN
    RAISE EXCEPTION
      'Refusing to reset retained anomaly/model state. Run SET safearms.allow_destructive_seed_reset = true only for an intentional full reset.';
  END IF;
END $$;
...
INSERT INTO ballistic_profiles (ballistic_id, firearm_id, test_date, test_location, rifling_characteristics, firing_pin_impression, ejector_marks, extractor_marks, chamber_marks, test_conducted_by, forensic_lab, test_ammunition, notes, created_by, is_locked, registration_hash) VALUES
  ('BP-001', 'FA-001', '2022-04-01', 'RNP Central Forensic Lab, Kigali',  '4 grooves, right-hand twist, 1:9.5 pitch',               'Rectangular, centered, 1.20mm x 0.80mm with shallow drag tail',     'Rectangular mark at 3 o''clock with light brass smear',      'Linear extractor score at 9 o''clock, medium depth',       'Stamped receiver marks with diagonal feed-ramp striation',       'Dr. Kamanzi Eric',   'RNP Central Forensic Lab',  '7.62x39mm FMJ 123gr', 'AK-47 profile; same broad family as AKM/AK-103 but distinct tool marks', 'USR-008', true, '2075de025f630033cfca0ba7dd37832f4dc2be2539ef2d032ea2f7e80c989f1d'),
  ('BP-002', 'FA-002', '2022-06-20', 'RNP Central Forensic Lab, Kigali',  '4 grooves, right-hand twist, 1:9.5 pitch',               'Rectangular, slight left offset, 1.10mm x 0.78mm',                  'Rectangular mark at 4 o''clock with chipped lower edge',     'Linear extractor mark at 8 o''clock, faint double line',    'Receiver marks with light wear and crescent chamber rub',        'Dr. Kamanzi Eric',   'RNP Central Forensic Lab',  '7.62x39mm FMJ 123gr', 'AKM comparison profile; close but not identical to BP-001',           'USR-008', true, 'ab473adb0a3655869decd16e84d0f935572f7f8c6499a3955344dee2b6651223'),
  ('BP-003', 'FA-003', '2023-04-01', 'RNP Central Forensic Lab, Kigali',  '6 grooves, right-hand twist, 1:7 pitch',                 'Circular, centered, 1.00mm diameter with crisp rim',               'Rectangular ejector mark at 2 o''clock, clean shoulder',     'Linear extractor mark at 8 o''clock with short secondary scratch', 'Clean chamber with moderate parallel tool marks',          'Dr. Ingabire Alice','RNP Central Forensic Lab',  '5.56mm M855 62gr',   'M4 carbine profile; useful for 5.56 comparison searches',          'USR-009', true, '9eab891fedf75adc17216b7f33820813c43ecd24c6e7c6886cbb883dce33c7c9'),
  ('BP-004', 'FA-004', '2021-10-05', 'RNP Central Forensic Lab, Kigali',  '6 grooves, right-hand twist, 1:10 pitch',                'Circular, centered, 0.82.mm with smooth primer rim',              'Semi-circular ejector mark at 4 o''clock',                    'Faint linear extractor mark at 10 o''clock',                'Open-slide feed marks with moderate breech wear',               'Dr. Kamanzi Eric',   'RNP Central Forensic Lab',  '9mm FMJ 115gr',      'Glock service pistol profile with visible breech wear',          'USR-008', true, '958c9cfd323fa709368bb0edc747da968f008383ef9cb05aeeba2cf22ef11e9e'),
  ('BP-005', 'FA-006', '2023-07-15', 'RNP Central Forensic Lab, Kigali',  '4 grooves, right-hand twist, 1:9.5 pitch',               'Rectangular, centered, 1.15mm x 0.80mm with vertical nick',        'Rectangular ejector mark at 3 o''clock, sharp right corner', 'Angular extractor mark at 9 o''clock, deep start point',    'Tight headspace with narrow chamber scrape',                   'Dr. Ingabire Alice','RNP Central Forensic Lab',  '7.62x39mm FMJ 123gr', 'AK-103 profile; strong demo candidate for 2025-08-04 incident search', 'USR-009', true, 'c1bef7cc096a6ad2fe2d17c3557a4c4e479aa5ef5d8aca84fdc9d274714e6799'),
  ('BP-006', 'FA-007', '2023-07-15', 'RNP Central Forensic Lab, Kigali',  '4 grooves, right-hand twist, 1:9.5 pitch',               'Rectangular, centered low, 1.10mm x 0.80mm',                       'Rectangular ejector mark at 4 o''clock, rounded top edge',   'Angular extractor mark at 9 o''clock, shallow finish',      'Clean chamber with single feed-ramp polish line',              'Dr. Ingabire Alice','RNP Central Forensic Lab',  '7.62x39mm FMJ 123gr', 'AKM comparison profile with related but weaker traits',             'USR-009', true, '22f748068c7469e4339e1704c32df7845f52b75ae7b39d526c2ae588bd6189ef'),
  ('BP-007', 'FA-008', '2024-01-20', 'RNP Central Forensic Lab, Kigali',  '6 grooves, right-hand twist, 1:7 pitch',                 'Circular, centered, 0.95mm diameter with light primer flow',       'Rectangular ejector mark at 2 o''clock, narrow face',        'Double scratch extractor marks at 11 o''clock',              'Crisp rifling with smooth chamber wall',                         'Dr. Kamanzi Eric',   'RNP Central Forensic Lab',  '5.56mm M855 62gr',   'AR-15 comparison profile; same rifling family as M4 but different extraction marks', 'USR-008', true, '08492828b1cb06f9425d560c48586262e1c2a094b584e2ddbaaece63f0ff8a36'),
  ('BP-008', 'FA-011', '2022-06-01', 'RNP Central Forensic Lab, Kigali',  '4 grooves, right-hand twist, 1:9.5 pitch',               'Rectangular, centered, 1.20mm x 0.80mm with flat base',            'Rectangular ejector mark at 3 o''clock, broad contact face', 'Faint extractor line at 8 o''clock',                         'Receiver marks consistent with older AK-pattern wear',           'Dr. Kamanzi Eric',   'RNP Central Forensic Lab',  '7.62x39mm FMJ 123gr', 'AK-47 station profile; broad family match with weaker extractor detail', 'USR-008', true, '3d9d7900e65c3538bd0aa99153ce79d8d8f15c34a812d24b6021d3c6e796abe5'),
  ('BP-009', 'FA-012', '2023-12-01', 'RNP Central Forensic Lab, Kigali',  '4 grooves, right-hand twist, 1:9.5 pitch',               'Rectangular, centered, 1.15mm x 0.80mm with bright rim',           'Rectangular ejector mark at 3 o''clock, pronounced lower corner', 'Pronounced extractor mark at 9 o''clock',                  'Light chamber wear with two short feed scratches',              'Dr. Ingabire Alice','RNP Central Forensic Lab',  '7.62x39mm FMJ 123gr', 'AK-103 rapid response profile; similar to BP-005 but different custody timeline', 'USR-009', true, '6d4e0ab4af7b132e4017a759bd4d98573d5198bf420f3b6b0f2f4987a68f1b2c'),
  ('BP-010', 'FA-015', '2022-09-01', 'RNP Central Forensic Lab, Kigali',  '4 grooves, right-hand twist, 1:9.5 pitch',               'Rectangular, centered high, 1.10mm x 0.80mm',                      'Rectangular ejector mark at 3 o''clock, faint upper edge',   'Faint extractor mark at 9 o''clock',                         'Clean chamber with minimal feed marking',                        'Dr. Kamanzi Eric',   'RNP Central Forensic Lab',  '7.62x39mm FMJ 123gr', 'AKM Kicukiro profile; useful for 2025-08-08 custody explanation', 'USR-008', true, 'af8a4b6e71cc74c94e304aab58d7b17db87d1f68650434496acee46f0b2b2e81'),
  ('BP-011', 'FA-019', '2024-02-01', 'RNP Central Forensic Lab, Kigali',  '6 grooves, right-hand twist, 1:10 pitch',                'Circular, perfectly centered, 0.81mm with smooth rim',            'Clean rectangular ejector mark at 3 o''clock',                 'Light linear extractor mark at 9 o''clock',                   'Factory-new feed ramp with shallow chamber polish',             'Dr. Kamanzi Eric',   'RNP Central Forensic Lab',  '9mm FMJ 124gr',      'HQ Glock reference profile; contrasts with worn station pistol profile', 'USR-008', true, 'ea94ae443c39935a20522cb4f45999117a921ad79aa6876c0929ef26eb956656'),
  ('BP-012', 'FA-020', '2024-02-01', 'RNP Central Forensic Lab, Kigali',  '6 grooves, right-hand twist, 1:7 pitch',                 'Circular, centered, 1.00mm diameter with slight primer wipe',      'Rectangular ejector mark at 2 o''clock, deeper face',         'Double linear extractor mark at 10 o''clock',                 'Sharp lands with clean chamber and fine longitudinal marks',     'Dr. Ingabire Alice','RNP Central Forensic Lab',  '5.56mm M855 62gr',   'M4 reference profile; useful for 2025-08-09 incident custody demo', 'USR-009', true, '380a4c497c70caf716d69089a56a3c02c65fc52737edd11443746ec4653a5ab1');
...
INSERT INTO custody_records (custody_id, firearm_id, officer_id, unit_id, custody_type, issued_at, issued_by, returned_at, returned_to, custody_duration_seconds, assignment_reason, notes, issue_hour, issue_day_of_week, is_night_issue, is_weekend_issue) VALUES
  ...
  -- FORENSIC DEMO: Returned custody records with case/incident notes for investigation search
  ('CUS-F01', 'FA-006', 'OFF-006', 'UNIT-KIM', 'temporary', '2025-08-04 12:30:00', 'USR-005', '2025-08-04 20:30:00', 'USR-005', 28800, 'Demo incident CAS-2025-0311 - Amahoro perimeter response', 'Assigned and returned same day. Incident date 2025-08-04; recovered 7.62x39 casing can be compared with AK-103 profile BP-005.', 12, 1, false, false),
  ('CUS-F02', 'FA-007', 'OFF-007', 'UNIT-KIM', 'temporary', '2025-08-04 06:45:00', 'USR-005', '2025-08-04 18:15:00', 'USR-005', 41400, 'Demo incident CAS-2025-0311 - Kimironko market patrol', 'Assigned and returned same day. Same incident date as CAS-2025-0311; AKM profile BP-006 is a plausible comparison alternative.', 6, 1, false, false),
  ('CUS-F03', 'FA-001', 'OFF-001', 'UNIT-NYA', 'temporary', '2025-08-05 15:30:00', 'USR-004', '2025-08-05 22:00:00', 'USR-004', 23400, 'Demo incident CAS-2025-0318 - Nyamirambo evening response', 'Assigned and returned after evening response. Incident date 2025-08-05; AK-47 profile BP-001 should appear as a custody-overlap candidate.', 15, 2, false, false),
  ('CUS-F04', 'FA-015', 'OFF-016', 'UNIT-KIC', 'temporary', '2025-08-08 11:00:00', 'USR-007', '2025-08-08 19:00:00', 'USR-007', 28800, 'Demo incident CAS-2025-0330 - Kicukiro roadblock support', 'Assigned and returned same day. Incident date 2025-08-08; AKM profile BP-010 gives a second Kicukiro AK-family comparison.', 11, 5, false, false),
  ('CUS-F05', 'FA-008', 'OFF-008', 'UNIT-KIM', 'temporary', '2025-08-09 06:30:00', 'USR-005', '2025-08-09 18:00:00', 'USR-005', 41400, 'Demo incident CAS-2025-0342 - stadium perimeter rifle detail', 'Assigned and returned same day. Incident date 2025-08-09; AR-15 profile BP-007 gives an alternative to HQ M4 profile BP-012.', 6, 6, false, true);
...
INSERT INTO ballistic_access_logs (access_id, ballistic_id, firearm_id, accessed_by, access_type, access_reason, firearm_status_at_access, current_custody_officer_id, current_custody_unit_id) VALUES
  ...
  ('BAL-F01', 'BP-005', 'FA-006', 'USR-009', 'forensic_query',       'Demo case CAS-2025-0311 - compare recovered 7.62x39 casing with AK-103 profile', 'available', NULL, 'UNIT-KIM'),
  ('BAL-F02', 'BP-006', 'FA-007', 'USR-009', 'forensic_query',       'Demo case CAS-2025-0311 - AKM alternative comparison on same incident date',     'available', NULL, 'UNIT-KIM'),
  ('BAL-F03', 'BP-001', 'FA-001', 'USR-008', 'forensic_query',       'Demo case CAS-2025-0318 - Nyamirambo AK-family evidence comparison',             'available', NULL, 'UNIT-NYA'),
  ('BAL-F04', 'BP-010', 'FA-015', 'USR-009', 'forensic_query',       'Demo case CAS-2025-0330 - Kicukiro AKM comparison with custody overlap',         'available', NULL, 'UNIT-KIC'),
  ('BAL-F05', 'BP-007', 'FA-008', 'USR-008', 'forensic_query',       'Demo case CAS-2025-0342 - AR-15 comparison alternative for 5.56 evidence',        'available', NULL, 'UNIT-KIM');
...
INSERT INTO audit_logs (log_id, user_id, action_type, table_name, record_id, new_values, success) VALUES
  ...
  ('L-F001', 'USR-005', 'CREATE', 'custody_records', 'CUS-F01', '{"action": "Demo custody insert", "case": "CAS-2025-0311", "firearm_id": "FA-006", "incident_date": "2025-08-04"}', true),
  ('L-F002', 'USR-005', 'CREATE', 'custody_records', 'CUS-F02', '{"action": "Demo custody insert", "case": "CAS-2025-0311", "firearm_id": "FA-007", "incident_date": "2025-08-04"}', true),
  ('L-F003', 'USR-004', 'CREATE', 'custody_records', 'CUS-F03', '{"action": "Demo custody insert", "case": "CAS-2025-0318", "firearm_id": "FA-001", "incident_date": "2025-08-05"}', true),
  ('L-F004', 'USR-007', 'CREATE', 'custody_records', 'CUS-F04', '{"action": "Demo custody insert", "case": "CAS-2025-0330", "firearm_id": "FA-015", "incident_date": "2025-08-08"}', true),
  ('L-F005', 'USR-005', 'CREATE', 'custody_records', 'CUS-F05', '{"action": "Demo custody insert", "case": "CAS-2025-0342", "firearm_id": "FA-008", "incident_date": "2025-08-09"}', true);
