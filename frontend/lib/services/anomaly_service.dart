...
class AnomalyService {
  ...
  void _disableResponseCache(Map<String, String> queryParams) {
  ...
  Future<List<Map<String, dynamic>>> getAnomalies({
    ...
    try {
      ...
      _addQueryParam(queryParams, 'unit_id', unitId);
  ...
  Future<List<Map<String, dynamic>>> searchForInvestigation({
    ...
    Map<String, String> queryParams = {};
    _addQueryParam(queryParams, 'unit_id', unitId);
    _addQueryParam(queryParams, 'start_date', startDate);
    _addQueryParam(queryParams, 'end_date', endDate);
    _addQueryParam(queryParams, 'severity', severity);
    _addQueryParam(queryParams, 'status', status);
    if (limit != null) queryParams['limit'] = limit.toString();
    if (offset != null) queryParams['offset'] = offset.toString();
